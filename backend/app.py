...
The "-u" forces unbuffered output so prints appear immediately.
"""
...
def create_app(config_class=Config):
    ...
    def after_request(response):
        ...
        if origin in ALLOWED_ORIGINS:
            ...
            # leave unset or default; this keeps things safe but still works for local dev
    ...
    try:
        ...
        #  - KPIs:   /api/v1/kpis/...
        #  - Branches / regional / me / users: no extra prefix (just /branches, /regional, /me, /users)
...
if __name__ == "__main__":
    ...
    try:
        ...
        debug_env = os.environ.get(
            "BACKEND_DEBUG", os.environ.get("FLASK_DEBUG", "True")
        )
